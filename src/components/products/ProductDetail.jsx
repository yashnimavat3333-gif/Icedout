...
export default function ProductDetail() {
  ...
  const productInfoSection = useMemo(() => {
    ...
    const getReviewData = (category) => {
      switch (category?.toLowerCase()) {
        case "luxury watch":
          return { reviews: 66, rating: 5 };
        case "plain watch":
          return { reviews: 120, rating: 5 };
        default:
          return { reviews: 24, rating: 4 }; // fallback
      }
    };

    const { reviews, rating } = getReviewData(product.categories);
